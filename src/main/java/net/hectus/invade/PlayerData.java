...
public class PlayerData {
    ...
    public void nextTask() {
        currentTask = switch (RANDOM.nextInt(5)) {
            ...
            case 3 -> new TransportTask(match, player, Randomizer.fromArray(Material.values()), Randomizer.fromArray(Building.values()));
            default -> new ItemSearchTask(match, player, Randomizer.fromArray(Material.values()));
        };
